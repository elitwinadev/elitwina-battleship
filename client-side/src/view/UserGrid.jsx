...
const UserGrid = () => {
  ...
  return (
    <UserGridWrapper bothPlayersConnected={bothPlayersConnected} lockOtherPlayerBoard={lockOtherPlayerBoard} bothPlayersReady={bothPlayersReady} isPlayerReady={isPlayerReady} isMyTurn={isMyTurn}>
...
@media only screen and (max-width: 600px) {
  ...
  {
${props => !props.lockOtherPlayerBoard ? `display: none;` : `display: grid` };
